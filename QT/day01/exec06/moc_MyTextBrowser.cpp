...
const QMetaObject MyTextBrowser::staticMetaObject = {
    { &QTextBrowser::staticMetaObject, qt_meta_stringdata_MyTextBrowser.data,
      qt_meta_data_MyTextBrowser,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MyTextBrowser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyTextBrowser.stringdata))
